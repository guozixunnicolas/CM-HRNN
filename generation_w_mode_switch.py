...
from lookup_table import decode_melody, decode_rhythm, index_to_chord, chord_symbol_to_midi_notes
...
def create_graph_bar_note(net):
    with tf.name_scope('infe_para'):
        ...
        infe_para['infe_frame_outp'], infe_para['infe_next_frame_state'] = net.frame_level(
                ...
                bigframe_out_slice=infe_para['infe_big_frame_outp_slices'],
    ...
    with tf.variable_scope(tf.get_variable_scope(),reuse = tf.AUTO_REUSE):
        with tf.name_scope('TOWER_0') as scope:
            ...
            (   gt,
                ...
                network_input_plder,
                network_output_plder  # noqa: E501
            )
            tf.get_variable_scope().reuse_variables()
